...
class Application {
    ...
    checkCollisions() {
        ...
        this.player.bounds = new BoundingBox(new Vector3D(this.player.position.x - h, this.player.position.y - h, this.player.position.z - h), new Vector3D(this.player.position.x + h, this.player.position.y + h, this.player.position.z + h));
