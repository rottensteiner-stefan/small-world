...
class Application {
    ...
    updatePlayerMovement() {
        ...
        if (dx !== 0 || dz !== 0) {
            ...
            this.flashLight.direction.set(Math.sin(this.player.rotation.y), -0.2, Math.cos(this.player.rotation.y)).normalize();
        }
    }
    updateCamera() {
