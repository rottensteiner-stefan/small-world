...
import { CullMode, MaterialType, RendererType, TextureFilter, TextureWrap, Topology, } from "../enums/index.js";
...
export class WebGL2Renderer extends AbstractWebGLRenderer {
     ...
     */
    _renderGroup(shaderId, materialGroups, vMat, topology = "triangle-list") {
        ...
        for (const materialGroup of materialGroups.values()) {
            ...
            for (const [name, value] of Object.entries(manifest.properties)) {
                ...
                if (typeof value === "number") {
                    ...
                    if (value.length === 4)
                        this.gl.uniform4fv(loc, new Float32Array(value));
                    else if (value.length === 3)
                        this.gl.uniform3fv(loc, new Float32Array(value));
                    else if (value.length === 2)
                        this.gl.uniform2fv(loc, new Float32Array(value));
                }
            }
            // --- 3. Bind Textures ---
