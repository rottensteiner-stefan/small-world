...
import { AmbientLight, BasicMaterial, CameraStrategyType, Color, Cube, DirectionalLight, FPSController, ZoomController, MathUtils, Object3D, PerspectiveProjection, Plane, PointLight, Texture, WorldMaterial, Tube, Circle, Disk, LavaMaterial, CullMode, Input, } from "../index.js";
...
export class Example10 extends AbstractExample {
    ...
    async setupScene() {
        ...
        this.controllers.push(new FPSController(this.camera, { moveSpeed: this._moveSpeed }), new ZoomController(this.camera));
