...
import { Cylinder } from "../../geometry/index.js";
export class ApothecaryBottle extends Object3D {
    constructor(name, options = {}) {
        super(name);
        const { radius = 1.0, height = 2.0, glassMaterial, stopperMaterial = glassMaterial, segments = 32, } = options;
        // Define proportions
        ...
        if (stopperMaterial)
            stopperStem.material = stopperMaterial;
        ...
        if (stopperMaterial)
            stopperTop.material = stopperMaterial;
        ...
        if (glassMaterial)
            innerBody.material = glassMaterial;
        ...
        if (glassMaterial)
            innerShoulder.material = glassMaterial;
        ...
        if (glassMaterial)
            innerNeck.material = glassMaterial;
        innerNeck.position.set(0, innerY + neckHeight / 2, 0);
        this.add(innerNeck);
    }
}
//# sourceMappingURL=ApothecaryBottle.js.map