...
import { AmbientLight, BoundingBox, CameraStrategyType, Color, DirectionalLight, Input, Keys, ObjLoader, PerspectiveProjection, ProjectionType, TerrainManager, TerrainMaterial, Texture, TextureGenerator, Vector3D, WASDController, } from "../index.js";
...
export class Example4 extends AbstractExample {
    ...
    async setupScene() {
        ...
        try {
            ...
            this.controllers.push(new WASDController(this._car, {
                moveSpeed: CAR_SPEED,
            }));
        }
        catch (error) {
