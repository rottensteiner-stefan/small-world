...
export class Matrix4 {
    ...
    static perspective(fov, aspect, near, far, target) {
    ...
    static invert(src, target) {
        const te = target.data;
        const n = src.data;
        const a0 = n[0], a1 = n[1], a2 = n[2], a3 = n[3];
        const b0 = n[4], b1 = n[5], b2 = n[6], b3 = n[7];
        const c0 = n[8], c1 = n[9], c2 = n[10], c3 = n[11];
        const d0 = n[12], d1 = n[13], d2 = n[14], d3 = n[15];
    ...
    static translate(x, y, z, target) {
        target.identity();
        target.data[12] = x;
        target.data[13] = y;
        target.data[14] = z;
    }
    static scale(x, y, z, target) {
