...
export interface Renderer {
     ...
     */
    setRenderTarget(target: import('../core/textures/RenderTarget.js').RenderTarget | import('../core/textures/RenderTargetCube.js').RenderTargetCube | null, activeCubeFace?: number): void;
    /**
