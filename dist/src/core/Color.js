export class Color {
    ...
    static get ORANGE() { return new Color(1, 0.5, 0); }
    static get DODGERBLUE() { return new Color(0.12, 0.56, 1); }
    static get SKYBLUE() { return new Color(0.53, 0.81, 0.92); }
    static get LIGHTSTEELBLUE() { return new Color(0.69, 0.77, 0.87); }
    static get DARKSLATEGRAY() { return new Color(0.18, 0.31, 0.31); }
