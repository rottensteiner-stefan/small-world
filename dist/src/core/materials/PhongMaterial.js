...
export class PhongMaterial extends AbstractMaterial {
    ...
    constructor(options = {}) {
        ...
        const { color = Color.WHITE, specularColor = Color.WHITE, shininess = 32.0, diffuseMap = undefined, normalMap = undefined, normalScale = new Vector2D(1, 1), specularMap = undefined, transparent = false, alphaTest = 0.0, } = options;
        this.color = color;
