...
export class Example15V2 extends AbstractExample {
  ...
  /** @inheritdoc */
  protected override onInspectorReady(_inspector: GadgetInspector): void {
  ...
  protected override update(deltaTime: number): void {
    ...
    */
    ...
    for (let i = 0; i < Example15V2.MAX_BALLS; i++) {
