...
export class Collision {
  public static test(a: IBoundingVolume, b: IBoundingVolume): boolean {
    ...
    if (a.type === BoundingType.SPHERE && b.type === BoundingType.SPHERE) return this.sphereSphere(a as BoundingSphere, b as BoundingSphere);
    if (a.type === BoundingType.BOX && b.type === BoundingType.BOX) return this.boxBox(a as BoundingBox, b as BoundingBox);
    if (a.type === BoundingType.SPHERE && b.type === BoundingType.BOX) return this.sphereBox(a as BoundingSphere, b as BoundingBox);
    if (a.type === BoundingType.BOX && b.type === BoundingType.SPHERE) return this.sphereBox(b as BoundingSphere, a as BoundingBox);
    return false;
  }
