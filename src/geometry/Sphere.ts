...
export class Sphere extends ObjectGeometry {
  constructor(public radius: number = 1, public widthSegments: number = 16, public heightSegments: number = 12) {
    super(); this.generateGeometryData();
  }
  protected generateGeometryData(): void {
    const v: number[] = []; const idx: number[] = [];
    ...
    this.vertices = new Float32Array(v); this.indices = new Uint16Array(idx);
  }
}
