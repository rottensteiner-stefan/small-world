    ...
    // 3. Konfiguration für deinen Engine-Code (Browser-Umgebung)
    {
        ...
        rules: {
            ...
            "no-restricted-syntax": [
                "error",
                {
                    "selector": "MethodDefinition[kind='constructor'] > FunctionExpression > Identifier[optional=true]:nth-child(n+3)",
                    "message": "Regel aus @AGENTS.md: Ein Konstruktor darf maximal 2 optionale Parameter haben. Nutze ab dem 3. Parameter ein 'Options Object'."
                }
            ]
        },
    },
